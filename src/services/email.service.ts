...
export class EmailService {
    ...
    async sendTrainingDashboardLink(to: string, token: string) {
        const frontendUrl = 'http://localhost:4200'; // Replace with your actual frontend URL
        const link = `${frontendUrl}/training?token=${token}`;

        const mailOptions = {
            from: `"BASM Tabletop Training" <${this.configService.get<string>('EMAIL_USER')}>`,
            to,
            subject: 'Your BASM Tabletop Training Session is Ready',
            html: `
        <!DOCTYPE html>
<html lang="en">
<head>
...
<title>BASM | Tabletop Training</title>
<style>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600" class="container">
          ...
          <tr>
            <td class="content-area">
              ...
              <p class="body-text">
                Your personalized <strong>BASM Tabletop Training</strong> session, based on your recent exercise results, is now ready.
              </p>
              <p class="body-text">
             ...
             <div style="text-align: center; margin: 40px 0;">
              ...
              <p class="link-note">*This personalized link will expire in 24 hours.</p>

              <p class="body-text" style="margin-top: 40px;">Thank you for your commitment to improving cybersecurity readiness.</p>
              <p>— The BASM Team</p>
            </td>
          </tr>
          ...
          <tr>
            <td class="footer">
              &copy; ${new Date().getFullYear()} BASM | Tabletop Training. All rights reserved.
            </td>
          </tr>
